...
const QUOTES: Quote[] = [
  { text: "Do what you <em>can't</em>.",
    author: "Casey Neistat", role: "YouTuber · Filmmaker" },
  { text: "Drama is life with the dull bits <em>cut out</em>.",
    author: "Alfred Hitchcock", role: "Film Director" },
  { text: "Curiosity turns a question into a <em>machine</em>.",
    author: "Mark Rober", role: "YouTuber · Engineer" },
  { text: "Cinema is a matter of what's in the frame and what's <em>out</em>.",
    author: "Martin Scorsese", role: "Film Director" },
  { text: "Make something so useful people would <em>miss it</em> if it disappeared.",
    author: "Marques Brownlee", role: "YouTuber · Tech Reviewer" },
  { text: "A film is — or should be — more like <em>music</em> than like fiction.",
    author: "Stanley Kubrick", role: "Film Director" },
  { text: "Seek <em>discomfort</em>.",
    author: "Yes Theory", role: "YouTube Creators" },
  { text: "I dream for a <em>living</em>.",
    author: "Steven Spielberg", role: "Film Director" },
  { text: "Small uploads become a career when you keep your <em>promise</em> to the audience.",
    author: "Ali Abdaal", role: "YouTuber · Educator" },
  { text: "When people ask if I went to film school I say: no, I went to <em>films</em>.",
    author: "Quentin Tarantino", role: "Film Director" },
  { text: "Every frame should earn its place in the <em>story</em>.",
    author: "Peter McKinnon", role: "YouTuber · Photographer" },
  { text: "An essential element of any art is <em>risk</em>.",
    author: "Francis Ford Coppola", role: "Film Director" },
  { text: "Go bigger only when the reason is <em>clearer</em>.",
    author: "MrBeast", role: "YouTuber · Philanthropic Creator" },
  { text: "Every great story demands that you trust the <em>audience</em>.",
    author: "Christopher Nolan", role: "Film Director" },
  { text: "The best episode starts with a question you cannot <em>ignore</em>.",
    author: "Veritasium", role: "YouTube Channel · Science" },
  { text: "Film is not the art of scholars, but of <em>illiterates</em>.",
    author: "Werner Herzog", role: "Documentary Director" },
  { text: "Keep going until the experiment teaches you something <em>unexpected</em>.",
    author: "SmarterEveryDay", role: "YouTube Channel · Science" },
  { text: "History becomes alive when the evidence starts to <em>breathe</em>.",
    author: "Ken Burns", role: "Documentary Director" },
];
