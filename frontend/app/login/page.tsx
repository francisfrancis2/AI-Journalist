...
const QUOTES: Quote[] = [
  ...
  { text: "The most political thing a documentary can do is pay <em>close attention</em>.",
    author: "Laura Poitras", role: "Documentary Director" },
  ...
  { text: "A documentary is not a mirror. It's a <em>hammer</em> with which to shape reality.",
    author: "Dziga Vertov", role: "Documentary Pioneer" },
  { text: "Every frame should earn its place in the <em>story</em>.",
    author: "Peter McKinnon", role: "YouTuber · Photographer" },
  { text: "The camera is the eye of <em>history</em>.",
    author: "Raoul Peck", role: "Documentary Director" },
  { text: "Go bigger only when the reason is <em>clearer</em>.",
    author: "MrBeast", role: "YouTuber · Philanthropic Creator" },
  { text: "The truth is usually found in the <em>details</em> people almost miss.",
    author: "Errol Morris", role: "Documentary Director" },
  ...
  { text: "Follow the people closest to the story and let the stakes <em>surface</em>.",
    author: "Barbara Kopple", role: "Documentary Director" },
];
