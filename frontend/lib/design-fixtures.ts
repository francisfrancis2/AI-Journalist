...
export const designFixtureStories: Story[] = [
  {
    ...
    revision: 1,
    pipeline_cycles_run: 1,
    pipeline_failure_summary: null,
    angles_data: null,
    selected_angle: null,
    ideation_stage: null,
    ideation_chat_data: null,
    ideation_research_data: null,
    ideation_operation_data: null,
    story_hook: null,
    hook_options_data: null,
    chapters_data: null,
    created_at: now,
    updated_at: now,
  },
  ...
  },
  {
    ...
    revision: 1,
    pipeline_cycles_run: 2,
    pipeline_failure_summary: "Storyline could not be approved after refinement.",
    angles_data: null,
    selected_angle: null,
    ideation_stage: null,
    ideation_chat_data: null,
