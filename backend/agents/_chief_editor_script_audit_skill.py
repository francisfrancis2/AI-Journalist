"""
Chief Editor Script Audit Skill — post-script audit for the finished documentary script.
...
class ScriptAuditSkill:
    """
    Chief Editor skill that turns script feedback into rewrite guidance.

    Example::

        skill = ScriptAuditSkill()
    ...
    async def run(self, state: dict) -> dict:
        ...
        if script is None:
            raise ValueError("chief editor script audit received no final_script")
        ...
        log.info(
            "chief_editor.script_audit.start",
            title=script.title,
        ...
        log.info(
            "chief_editor.script_audit.complete",
            title=script.title,
        ...
        return {
            ...
            "script_rewrite_recommendations": report.rewrite_priorities,
