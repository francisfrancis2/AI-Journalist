...
Usage:
    ...
    python -m backend.scripts.build_corpus --docs 125      # docs per component corpus
...
async def main(max_docs: int, library_key: str) -> None:
    ...
    print(f"Building benchmark corpus '{library_key}' with target {max_docs} docs per library...")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--docs", type=int, default=125, help="Target docs per component library (default: 125)")
    parser.add_argument(
        "--library",
        default="combined",
