...
- Strengthen transitions so the section feels connected to the documentary's larger argument.
- Replace vague explanation with sourced specifics whenever the provided facts allow it.
- Keep successful lines and ideas from the original section when the audit identifies them as strengths.
